							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<button class="btn btn-sm btn-primary edit_category" type="button" data-id="<?php echo $row['id'] ?>" data-category="<?php echo $row['category'] ?>" data-description="<?php echo $row['description'] ?>" >Edit</button>
...
<script>
	function _reset(){
		...
		$('#manage-category input,#manage-category textarea').val('')
	}
